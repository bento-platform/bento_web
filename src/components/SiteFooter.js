      ...
      <Layout.Footer>
        ...
        >
          ...
          <div style={{textAlign: "center"}}>
            ...
            <a href="http://computationalgenomics.ca">
              Canadian Centre for Computational Genomics
            </a>
            . <br />
            <span style={{fontFamily: "monospace"}}>bento_web</span> is licensed
            under the{" "}
            <a href="https://github.com/bento-platform/bento_web/blob/master/LICENSE">
              LGPLv3
            </a>
