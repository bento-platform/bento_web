...
class DataUseDisplay extends Component {
    render() {
        ...
        const uses =
            this.props.dataUse.data_use_requirements.map((u) => u.code) || [];
            ...
            <>
                        ...
                        <Col>
                            ...
                            >
                                <Tag color="blue" style={TAG_STYLING}>
                                    {
                                        this.props.dataUse.consent_code
                        ...
                        <Col>
                            ...
                            {this.props.dataUse.consent_code
                                .secondary_categories.length > 0 ? (
                                    this.props.dataUse.consent_code.secondary_categories.map(
                                        (sc) => (
                                        <Popover
                                            {...SECONDARY_CONSENT_CODE_INFO[
                                                sc.code
                ...
                <div style={{ marginTop: "20px" }}>
                    ...
                    <List
                        ...
                        dataSource={DATA_USE_KEYS.filter((u) =>
                            uses.includes(u)
                        )}
                        renderItem={(u) => (
                            <List.Item>
