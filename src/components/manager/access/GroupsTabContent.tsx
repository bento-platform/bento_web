                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      modal.confirm({
                        title: (
                          <>
                            Are you sure you wish to delete group &ldquo;{group.name}&rdquo; (ID: {group.id}), as well
                        ...
                        content: (
                          <Typography.Paragraph>
                            ...
                            affect <strong>your own</strong> access!
                          </Typography.Paragraph>
                        ),
  ...
  return (
    <>
      ...
      <ActionContainer style={{ marginBottom: 8 }}>
        {hasEditPermission && (
          <Button icon={<PlusOutlined />} loading={isFetchingPermissions || isFetchingGroups} onClick={openCreateModal}>
            Create Group
          </Button>
        )}
      </ActionContainer>
