...
const ManagerProjectDatasetContent = ({
    ...
    return (
        <>
            ...
            <Layout>
                {!loadingAuthDependentData && projectMenuItems.length === 0 ? (
                    <Layout.Content style={LAYOUT_CONTENT_STYLE}>
                        ...
                        >
                            ...
                            >
                                To create datasets and ingest data, you have to
                                create a CHORD project first. CHORD projects
                                have a name and description, and let you group
                                related datasets together. You can then specify
                                project-wide consent codes and data use
                            ...
                            >
                                ...
                                >
                                    <Button
                                        ...
                                        style={{ width: "100%" }}
                                        onClick={toggleProjectCreationModal}
                                        loading={loadingAuthDependentData}
                                        disabled={loadingAuthDependentData}
                                        icon="plus"
                                    >
                                        Create Project
                                    </Button>
                        ...
                        <Layout.Content style={LAYOUT_CONTENT_STYLE}>
                            ...
                            {projectMenuItems.length > 0 ? (
                                <Switch>
                                    <Route
                                        path={withBasePath(
                                            "admin/data/manager/projects/:project"
                                        )}
                                        component={RoutedProject}
                                    />
                                    <Redirect
                                        from={withBasePath(
                                            "admin/data/manager/projects"
                                        )}
                                        to={withBasePath(
                                            `admin/data/manager/projects/${projects[0].identifier}`
                                        )}
                                    />
                                </Switch>
                            ) : loadingAuthDependentData ? (
