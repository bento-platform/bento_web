    ...
    <div>
      ...
      {value && (
        <>
          ...
          <Button key="cancel" onClick={() => onChange(null)}>
            Remove
          </Button>
        </>
      )}
      ...
      <Form.Item
        label={
          <Tooltip
            title={
              <span>
                The data type on which this <ExtraPropertiesCode tooltip /> schema will be applied
              </span>
            }
          >
            Schema Type
        ...
        rules={[{ required: true }]}
      >
        <Select options={getSchemaTypeOptions(schemaTypes).map(({ value, text: label }) => ({ value, label }))} />
      </Form.Item>
      ...
      <Form.Item
        label={
          <Tooltip
            title={
              <span>
                Check to make the <ExtraPropertiesCode tooltip /> field required
              </span>
            }
          >
            <span>Required</span>
