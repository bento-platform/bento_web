...
class TableTreeSelect extends Component {
    ...
    render() {
        ...
        const getTableName = (serviceID, tableID) =>
            this.props.tablesByServiceID[serviceID]?.tablesByID?.[tableID]
                ?.name;
                ...
                children: (this.props.projectTables[p.identifier] ?? [])
                    .filter(
                        (t) =>
                            ...
                            (
                                this.props.tablesByServiceID?.[t.service_id]
                                    ?.tablesByID ?? {}
                    ...
                    .map((t) => ({
                        ...
                        dataType:
                            this.props.tablesByServiceID[t.service_id]
                                .tablesByID[t.table_id].data_type,
                    }))
                    .map((t) => ({
                        title: (
                            <>
                        ...
                        disabled: !(
                            dataType === null || dataType === t.dataType
                        ),
                        isLeaf: true,
        ...
        return (
            <Spin
                spinning={
                    this.props.servicesLoading || this.props.projectsLoading
                }
            >
                <TreeSelect
