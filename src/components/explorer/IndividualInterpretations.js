    ...
    <Descriptions layout="horizontal" bordered={true} column={1} size="small">
      ...
      <Descriptions.Item label="Variant Descriptor">
        ...
        <Modal
          ...
          footer={null}
        >
          <VariantDescriptor variationDescriptor={variationInterpretation.variation_descriptor} />
        </Modal>
      </Descriptions.Item>
    </Descriptions>
  );
  ...
  return (
    <Descriptions layout="horizontal" bordered={true} column={1} size="small">
      ...
      {variantInterpretation && (
        <Descriptions.Item label="Variant Interpretation">
          <VariantInterpretation variationInterpretation={variantInterpretation} />
        </Descriptions.Item>
      )}
      {geneDescriptor && (
        <Descriptions.Item label="Gene Descriptor">
  ...
  return (
    <div className="experiment_and_results">
      ...
      {sortedGenomicInterpretations.length ? (
        <IndividualGenomicInterpretations genomicInterpretations={sortedGenomicInterpretations} />
      ) : null}
    </div>
  );
};
...
const expandedInterpretationRowRender = (interpretation) => <InterpretationDetail interpretation={interpretation} />;
