...
const METADATA_COLUMNS = [
    ...
    },
    {
        ...
        sorter: (a, b) =>
            a.namespace_prefix.toString().localeCompare(b.namespace_prefix),
        defaultSortOrder: "ascend",
    },
    {
        title: "Url",
        key: "url",
        render: (_, individual) => (
            <a target="_blank" rel="noopener noreferrer" href={individual.url}>
                {individual.url}
            </a>
        ),
        defaultSortOrder: "ascend",
    ...
    },
    {
        ...
        render: (_, individual) => (
            <a
                ...
                href={individual.iri_prefix}
            >
                {individual.iri_prefix}
            </a>
        ),
        defaultSortOrder: "ascend",
    },
