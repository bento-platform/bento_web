...
class ExplorerDatasetSearch extends Component {
    ...
    render() {
        ...
        const selectedDataset =
            this.props.datasetsByID[this.props.match.params.dataset];
                    ...
                    <>
                        <Typography.Title level={4}>
                            ...
                            <Spin
                                ...
                                spinning={this.props.fetchingSearch}
                            ></Spin>
                            <div
                            ...
                            Visualize Tracks</Button> */}
                                ...
                                <Spin
                                    spinning={this.props.isFetchingDownload}
                                    style={{
                                ...
                                >
                                    <Button
                                        ...
                                        onClick={() =>
                                            this.props.performIndividualsDownloadCSVIfPossible(
                                                this.props.selectedRows,
                                                this.props.searchResults
                                                    .searchFormattedResults
                                            )
                                        }
                                    >
                                        Export as CSV
                        ...
                        <SearchTracksModal
                            ...
                            onCancel={() =>
                                this.setState({ tracksModalVisible: false })
                            }
                        />
