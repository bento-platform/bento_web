...
const COMPLEX_VALUE_COLUMNS = [
  ...
  },
  {
    title: "Quantity",
    key: "quantity",
    render: (_, typedQuantity) => <Quantity quantity={typedQuantity.quantity} />,
  },
];
...
const MeasurementValue = ({ measurement }) => (
  <>
    {measurement?.value && <Value value={measurement.value} />}
    {measurement?.complex_value && <ComplexValue complexValue={measurement.complex_value} />}
  </>
);
...
const MeasurementDetails = ({ measurement }) => (
  <Descriptions bordered column={1} size="small">
    ...
    <Descriptions.Item label="Procedure">
      {measurement?.procedure ? <Procedure procedure={measurement.procedure} /> : EM_DASH}
    </Descriptions.Item>
  </Descriptions>
);
...
const MEASUREMENTS_COLUMNS = [
  ...
  },
  {
    ...
    key: "procedure",
    render: (_, measurement) => <OntologyTerm term={measurement?.procedure?.code} />,
  },
];

const expandedMeasurementRowRender = (measurement) => <MeasurementDetails measurement={measurement} />;
