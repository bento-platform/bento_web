    ...
    handleSubmit() {
        ...
        this.form.validateFields(async (err, values) => {
            ...
            if (mode === FORM_MODE_ADD) {
                await this.props.addLinkedFieldSet(
                    newLinkedFieldSet,
                    onSuccess
                );
            } else {
                await this.props.saveLinkedFieldSet(
                    newLinkedFieldSet,
                    onSuccess
                );
            }
    ...
    render() {
        ...
        const modalTitle =
            mode === FORM_MODE_ADD
                ...
                : `Edit Linked Field Set "${
                    this.props.linkedFieldSet?.name ?? ""
                }" on Dataset "${this.props.dataset.title}"`;
