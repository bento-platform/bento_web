...
class DatasetFormModal extends Component {
    ...
    async handleSuccess(values) {
        ...
        await (this.props.onOk || nop)({
            ...(this.props.initialValue || {}),
            values,
        });
        if ((this.props.mode || FORM_MODE_ADD) === FORM_MODE_ADD)
        ...
        return this.props.project ? (
            <Modal
                ...
                footer={[
                    ...
                    <Button
                        ...
                        loading={
                            this.props.projectsFetching ||
                            this.props.projectDatasetsAdding ||
            ...
            >
                <DatasetForm
                    ...
                    initialValue={
                        mode === FORM_MODE_ADD ? null : this.props.initialValue
                    }
                />
            </Modal>
        ) : null;
