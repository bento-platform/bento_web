...
class DatasetTables extends Component {
    constructor(props) {
        ...
        this.handleTableDeletionClick =
            this.handleTableDeletionClick.bind(this);
        this.handleTableDeletionCancel =
            this.handleTableDeletionCancel.bind(this);
        this.handleTableDeletionSubmit =
            this.handleTableDeletionSubmit.bind(this);
    ...
    async handleAdditionSubmit(values) {
        ...
        await this.props.addProjectTable(
    ...
    showTableSummaryModal(table) {
        this.props.fetchTableSummaryIfPossible(
            this.props.chordServicesByArtifact[table.service_artifact],
            this.props.serviceInfoByArtifact[table.service_artifact],
            table.table_id
        ); // TODO
    ...
    render() {
                ...
                render: (tableID, t) =>
                    this.props.isPrivate ? (
                        <a
                            ...
                            onClick={() => this.showTableSummaryModal(t)}
                        >
                            {tableID}
                        </a>
                    ) : (
        ...
        return (
            <>
                ...
                <TableSummaryModal
                    visible={this.state.tableSummaryModalVisible}
                ...
                <TableAdditionModal
                    visible={this.state.additionModalVisible}
