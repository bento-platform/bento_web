    ...
    handleFieldSetDeletion(fieldSet, index) {
        const deleteModal = Modal.confirm({
            ...
            onOk: async () => {
                ...
                await this.props.deleteLinkedFieldSet(
                    this.state,
                    fieldSet,
                    index
                );
            ...
            linked_field_sets: (
                <>
                    ...
                    <Typography.Paragraph style={{ maxWidth: "600px" }}>
                        ...
                        share the same &ldquo;value space&rdquo;) between
                        multiple data types. For example, these sets can be used
                        to tell the discovery system that Phenopacket biosample
                        identifiers are the same as variant call sample
                        identifiers, and so variant calls with an identifier of
                        &ldquo;sample1&rdquo; come from a biosample with
                        identifier &ldquo;sample1&rdquo;.
                    </Typography.Paragraph>
                    <Typography.Paragraph style={{ maxWidth: "600px" }}>
                        A word of caution: the more fields added to a Linked
                        Field Set, the longer it takes to search the dataset in
                        question.
                    </Typography.Paragraph>
                    {(this.state.linked_field_sets || {}).length === 0 ? (
                        ...
                        <Row gutter={[16, 24]}>
                            {(this.state.linked_field_sets || []).map(
                                (fieldSet, i) => (
                ...
                content: (
                    <>
                        <Typography.Paragraph>
                            ...
                            permanently, and the dataset will no longer be
                            available for discovery within the CHORD federation.
                ...
                {isPrivate ? (
                    <>
                        ...
                        <LinkedFieldSetModal
                            ...
                            linkedFieldSet={
                                this.state.selectedLinkedFieldSet.data
                            }
                            linkedFieldSetIndex={
                                this.state.selectedLinkedFieldSet.index
                            }
                            onSubmit={() =>
                                this.setState({
                                    fieldSetEditModalVisible: false,
