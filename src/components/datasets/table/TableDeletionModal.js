        ...
        return (
            <Modal
                ...
                footer={[
                    <Button
                        key="cancel"
                        onClick={() => (this.props.onCancel || nop)()}
                    >
                        Cancel
                    </Button>,
                    <Button
            ...
            >
                <Typography.Paragraph>
                    Deleting this table means all data contained in the table
                    will be deleted permanently, and the will no longer be
                    available for discovery within the current Bento federation.
