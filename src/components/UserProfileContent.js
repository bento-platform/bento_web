            ...
            <Layout.Content style={LAYOUT_CONTENT_STYLE}>
                {idTokenContents ? (
                    <Descriptions bordered={true} style={DESCRIPTIONS_STYLE}>
                        <Descriptions.Item label="Username" span={3}>{username}</Descriptions.Item>
                        <Descriptions.Item label="Issuer" span={3}>{iss}</Descriptions.Item>
                        <Descriptions.Item label="Subject ID" span={3}>{sub}</Descriptions.Item>
                    </Descriptions>
