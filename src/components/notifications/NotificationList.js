...
import {
    NOTIFICATION_WES_RUN_COMPLETED,
    NOTIFICATION_WES_RUN_FAILED,
    navigateToWESRun,
...
class NotificationList extends Component {
    ...
    render() {
        const processedNotifications = this.props.notifications
            .map((n) => ({
                ...n,
                    ...
                    <List.Item
                        ...
                        actions={[
                            ...
                            <Button
                                ...
                                style={{ padding: 0 }}
                                onClick={() =>
                                    this.props.markNotificationAsRead(n.id)
                                }
                            >
                                Mark as Read
                            </Button>,
...
const mapStateToProps = (state) => ({
    fetchingNotifications:
        state.services.isFetchingAll || state.notifications.isFetching,
});

const mapDispatchToProps = (dispatch, ownProps) => ({
    ...bindActionCreators({ markNotificationAsRead }, dispatch),
    navigateToWESRun: (target) =>
        navigateToWESRun(target, dispatch, ownProps.history),
});
