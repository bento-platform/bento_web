...
const pageMenu = (artifact) => [
    {
        url: withBasePath(`admin/services/${artifact}/overview`),
        ...
        return (
            <>
                <SitePageHeader
                    ...
                    withTabBar={true}
                    onBack={() =>
                        this.props.history.push(withBasePath("dashboard"))
                    }
                />
                <Suspense
                    fallback={
                ...
                >
                    <Switch>
                        <Route
                            exact
                            path={withBasePath(
                                "admin/services/:artifact/overview"
                            )}
                            component={ServiceOverview}
                        />
                        <Route
                            path={withBasePath("admin/services/:artifact/logs")}
                            component={ServiceLogs}
                        />
                        <Redirect
                            from={withBasePath(`admin/services/${artifact}`)}
                            to={withBasePath(
                                `admin/services/${artifact}/overview`
                            )}
                        />
