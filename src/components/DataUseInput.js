        ...
        this.triggerChange({
            consent_code: {
                ...
                secondary_categories: event.target.checked
                    ...
                    : this.state.consent_code.secondary_categories.filter(
                        (c) => c.code !== code
                    ),
            },
        });
    ...
    handleDURChange(event, code) {
        this.triggerChange({
            data_use_requirements: event.target.checked
                ...
                : this.state.data_use_requirements.filter(
                    (c) => c.code !== code
                ),
        });
    }
            ...
            <>
                <div>
                    ...
                    <Radio.Group
                        ...
                        value={
                            (
                                this.state.consent_code.primary_category ?? {
                                    code: null,
                                }
                            ).code
                        }
                        ...
                        {SECONDARY_CONSENT_CODE_KEYS.map((scc) => (
                            <List.Item key={scc}>
                                <List.Item.Meta
                                    title={
                                        <Checkbox
                                            checked={this.state.consent_code.secondary_categories
                                                .map((c) => c.code)
                                                .includes(scc)}
                                            onChange={(e) =>
                                                this.handleSCCChange(e, scc)
                                            }
                                        >
                                            {
                        ...
                        renderItem={(u) => (
                            <List.Item>
                                <List.Item.Meta
                                    ...
                                    title={
                                        <Checkbox
                                            checked={this.state.data_use_requirements
                                                .map((c) => c.code)
                                                .includes(u)}
                                            onChange={(e) =>
                                                this.handleDURChange(e, u)
                                            }
                                        >
