...
const FIELD_COLUMNS = [
  {
    title: "Key",
    dataIndex: "key",
    render: (t) => <span style={{ fontFamily: "monospace", fontSize: "12px", whiteSpace: "nowrap" }}>{t}</span>,
  },
      ...
      children:
        this.state.view === "tree" ? (
          ...
          <>
            ...
            />
            <Table bordered={true} columns={FIELD_COLUMNS} dataSource={this.getTableData(dataType)} />
          </>
        ),
    }));

    return (
      <Modal title="Help" open={this.props.open} width={1280} onCancel={this.props.onCancel || nop} footer={null}>
