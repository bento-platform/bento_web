...
export const refreshTokens = createAsyncThunk("auth/REFRESH_TOKENS", async (_args, thunkAPI) => {
...
export const fetchResourcePermissionsIfPossibleAndNeeded = createAsyncThunk("auth/FETCH_RESOURCE_PERMISSIONS", async ({ resource, permission }, thunkAPI) => {
...
export const authSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchResourcePermissionsIfPossibleAndNeeded.pending, (state, { meta }) => {
            ...
            .addCase(fetchResourcePermissionsIfPossibleAndNeeded.fulfilled, (state, { meta, payload }) => {
                const key = makeResourceKey(meta.arg.resource);
                state.resourcePermissions[key] = {
                    ...state.resourcePermissions[key],
                    isFetching: false,
            ...
            .addCase(fetchResourcePermissionsIfPossibleAndNeeded.rejected, (state, { meta, payload }) => {
                const key = makeResourceKey(meta.arg.resource);
                state.resourcePermissions[key] = {
                    ...state.resourcePermissions[key],
                    isFetching: false,
