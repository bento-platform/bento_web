...
export const experimentResultPropTypesShape = PropTypes.shape({
    ...
    file_format: PropTypes.oneOf([
        "SAM", "BAM", "CRAM", "BAI", "CRAI", "VCF", "BCF", "GVCF",
        "BigWig", "BigBed", "FASTA", "FASTQ", "TAB", "SRA", "SRF", "SFF",
        "GFF", "TABIX", "3gp", "aac", "flac", "m4a", "mp3", "ogg", "wav",
        "apng", "avif", "bmp", "gif", "jpg", "jpeg", "png", "svg", "webp",
        "mp4", "webm", "docx", "pdf", "csv", "tsv", "xls", "xlsx", "bash",
        "json", "md", "txt", "py", "r", "sh", "xml", "Dockerfile",
        "README", "CHANGELOG", "UNKNOWN", "OTHER",
    ]),
