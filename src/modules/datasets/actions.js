...
const fetchDatasetDataTypesSummary = networkAction((serviceInfo, datasetID) => ({
  ...
  url: `${serviceInfo.url}/${(serviceInfo.bento?.serviceKind ?? serviceInfo.type?.artifact) === "metadata" ? "datasets_v2" : "datasets"}/${datasetID}/data-types`,
}));
...
const fetchServiceDatasetSummary = networkAction((serviceInfo, datasetID) => ({
  ...
  params: { serviceInfo, datasetID },
  url: `${serviceInfo.url}/${(serviceInfo.bento?.serviceKind ?? serviceInfo.type?.artifact) === "metadata" ? "datasets_v2" : "datasets"}/${datasetID}/summary`,
}));
